...
func TestFillShadingPaintsGradientAcrossShape(t *testing.T) {
	...
	c.FillShading(path, graphics.NonZero, sh, nil)
...
func TestFillShadingRespectsClip(t *testing.T) {
	...
	c.FillShading(full, graphics.NonZero, sh, []graphics.ClipPath{{Path: clip, Rule: graphics.NonZero}})
...
func TestPaintShadingRespectsClip(t *testing.T) {
	...
	c.PaintShading(sh, []graphics.ClipPath{{Path: clip, Rule: graphics.NonZero}})
